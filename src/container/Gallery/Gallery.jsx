    ...
    return (
        <div className="app__gallery flex__center">
            <div className="app__gallery-content">
                ...
                <p className="p__opensans" style={{color: '#aaa', marginTop: '2rem'}}>Aute est ea cillum incididunt
                    nostrud consectetur eu officia quis. Consectetur reprehenderit magna adipisicing culpa.</p>
